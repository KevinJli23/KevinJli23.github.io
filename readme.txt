...
I completed the project over the span  of a week with about 2-3 hours each day learning the new syntax and formatting.


4. What online resources did you consult when completing this assignment? (list specific URLs)
developer tool when inspecting a website
Wave chrome extension 
https://validator.w3.org/nu/#file
https://jigsaw.w3.org/css-validator/validator
https://getbootstrap.com/docs/5.0/components/navbar/
https://fonts.google.com/?selected=Material+Symbols+Outlined:house:FILL@0;wght@400;GRAD@0;opsz@24&icon.query=house&icon.platform=web
...
I discussed with people sitting around me before lecture, mainly about the alt function and changing specific css attributes about bootstrap and the colors
